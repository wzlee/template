...
import com.cn.template.xutil.enums.Gender;
...
public class WeixinUser extends IdEntity {
	...
	public String getSubscribeValue() {
		if(subscribe!=null){
			return Whether.values()[subscribe].getValue();
		}else{
			return Whether.NOT.getValue();
		}
	}
	...
	public String getSexValue() {
		if(sex!=null){
			return Gender.values()[sex].getValue();
		}else{
			return Gender.UNKNOW.getValue();
		}
	}
